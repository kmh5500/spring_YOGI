...
//		wdate = wdate.substring(0, 10);
	...
	/** 
	 ...
	 public static String paging3(int totalRecord, int nowPage, int recordPerPage, String col, String word){ 
	   ...
	   str.append("    text-align: center;");    
	   str.append("    background-color: #ff0000;"); 
...
//		     str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
		   ...
		   if (nowGrp < totalGrp){ 
		     str.append("<span class='span_box_1'><A href='./"+url+"?col="+col
		    		 +"&bbsno="+bbsno +"&nPage="+_nPage
		    		 +"&word="+word+"&nowPage="+nowPage+"'>다음</A></span>"); 
		   } 
		   str.append("</DIV>"); 
	...
	public static String paging4(int totalRecord, int nowPage, int recordPerPage, String type, int srprice, int erprice, String sdate, String edate, int rperson){ 
		   int pagePerBlock = 10; // 블럭당 페이지 수 
		   int totalPage = (int)(Math.ceil((double)totalRecord/recordPerPage)); // 전체 페이지  
		   int totalGrp = (int)(Math.ceil((double)totalPage/pagePerBlock));// 전체 그룹 
		   int nowGrp = (int)(Math.ceil((double)nowPage/pagePerBlock));    // 현재 그룹 
...
//		     str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
		   ...
		   int _nowPage = (nowGrp-1) * pagePerBlock; // 10개 이전 페이지로 이동 
		   if (nowGrp >= 2){ 
		     str.append("<span class='span_box_1'><A href='./list.do?type="+type+"&srprice="+srprice+"&erprice="+erprice+"&sdate="+sdate+"&edate="+edate+"&rperson="+rperson+"&nowPage="+_nowPage+"'>이전</A></span>"); 
		   } 
		   ...
		   for(int i=startPage; i<=endPage; i++){ 
		     ...
		     if (nowPage == i){ 
		       ...
		       str.append("<span class='span_box_1'><A href='./list.do?type="+type+"&srprice="+srprice+"&erprice="+erprice+"&sdate="+sdate+"&edate="+edate+"&rperson="+rperson+"&nowPage="+i+"'>"+i+"</A></span>");   
		     } 
		   } 
		    
		   _nowPage = (nowGrp * pagePerBlock)+1; // 10개 다음 페이지로 이동 
		   if (nowGrp < totalGrp){ 
		     str.append("<span class='span_box_1'><A href='./list.do?type="+type+"&srprice="+srprice+"&erprice="+erprice+"&sdate="+sdate+"&edate="+edate+"&rperson="+rperson+"&nowPage="+_nowPage+"'>다음</A></span>"); 
		   } 
		   str.append("</DIV>"); 
	...
	public static String paging5(int totalRecord, int nowPage, int recordPerPage){ 
		   int pagePerBlock = 10; // 블럭당 페이지 수 
		   int totalPage = (int)(Math.ceil((double)totalRecord/recordPerPage)); // 전체 페이지  
		   int totalGrp = (int)(Math.ceil((double)totalPage/pagePerBlock));// 전체 그룹 
		   int nowGrp = (int)(Math.ceil((double)nowPage/pagePerBlock));    // 현재 그룹 
...
//		     str.append("현재 페이지: " + nowPage + " / " + totalPage + "  "); 
		   ...
		   int _nowPage = (nowGrp-1) * pagePerBlock; // 10개 이전 페이지로 이동 
		   if (nowGrp >= 2){ 
		     str.append("<span class='span_box_1'><A href='./rlist.do?nowPage="+_nowPage+"'>이전</A></span>"); 
		   } 
		   ...
		   for(int i=startPage; i<=endPage; i++){ 
		     ...
		     if (nowPage == i){ 
		       ...
		       str.append("<span class='span_box_1'><A href='./rlist.do?nowPage="+i+"'>"+i+"</A></span>");   
		     } 
		   } 
		    
		   _nowPage = (nowGrp * pagePerBlock)+1; // 10개 다음 페이지로 이동 
		   if (nowGrp < totalGrp){ 
		     str.append("<span class='span_box_1'><A href='./rlist.do?nowPage="+_nowPage+"'>다음</A></span>"); 
		   } 
		   str.append("</DIV>"); 
