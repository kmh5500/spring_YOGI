...
<body>
<div class="container" >
<h2><span class="glyphicon glyphicon-pencil"></span>호텔 수정</h2>
...
<FORM name='frm' method='POST' action='./update'
  ...
  <TABLE class="table table-bordered">    
    ...
    <TR>
      <TH>전화번호</TH>
      <TD colspan=2><input type="text" name="hphone" size="15" value="${dto.hphone }"></TD>
    </TR>
    <TR>
      <TH>이메일</TH>
      <TD><input type="text" name="hemail" size="25" value="${dto.hemail }">
    ...
    <TR>
      <TH>사진</TH>
      <TD>
      	<img src="${root }/hotel/storage/${param.oldfile}" width="200px" heigh="200px"><br>
      	<input type="file" name="fnameMF" accept=".jpg,.png,.gif"></TD>
      <td style="width: 263px; ">사진은 JPG, PNG, GIF파일만 올려주세요.</td>
    </TR>
    <tr>
    	<th>체크인</th>
    	<td colspan=2><input type="text" name="hcheckin" size="15" value="${dto.hcheckin }">
    </tr>
    <tr>
    	<th>체크아웃</th>
    	<td colspan=2><input type="text" name="hcheckout" size="15" value="${dto.hcheckout }">
    </tr>
    <TR>
      <TH>호텔 정보</TH>
      <TD colspan=2><textarea rows="10" cols="45" name="hinfo">${dto.hinfo }</textarea></TD>
    </TR>
  </TABLE>
