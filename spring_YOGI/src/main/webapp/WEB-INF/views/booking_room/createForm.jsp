...
<div>
  ...
  <form action="create">
    ...
    <div style="float: left; width: 30%; margin-bottom: 10%;">
    ...
    <div style="float: right; width: 30%; background-color: #f0eef0; margin-top: 5%; margin-bottom: 10%;">
      ...
      <div onclick="booking(this.form)" style="text-align: center; padding: 2% 0%; background-color: #cc0000; cursor:pointer;">
		<h3>예약하기</h3>
      </div>
    </div>
